...
namespace Core.Extensions
{
    ...
    {
        public static List<string> Claims(this ClaimsPrincipal claimsPrincipal, string claimType) // ClaimsPrincipal => bir kişinin o anki jwt ile gelen kişinin claimlerine erişmek için bulunan class
        {
